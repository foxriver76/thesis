...
from skmultiflow.meta.oza_bagging_adwin import OzaBaggingADWINClassifier as OzaBaggingAdwin
from prototype_lvq.model.rrslvq import ReactiveRobustSoftLearningVectorQuantization as RRSLVQ
from skmultiflow.trees.hoeffding_adaptive_tree import HoeffdingAdaptiveTreeClassifier as HAT
from skmultiflow.lazy.sam_knn import SAMKNNClassifier as SAMKNN
from skmultiflow.meta.adaptive_random_forests import AdaptiveRandomForestClassifier as AdaptiveRandomForest
...
def evaluate(stream,metrics,study_size):
    ...
    evaluator = EvaluatePrequential(show_plot=False, batch_size=10, max_samples=study_size, metrics=metrics,
                                    output_file='_'+stream.name+"_time_other.csv")
